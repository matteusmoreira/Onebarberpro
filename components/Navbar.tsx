    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-semibold tracking-wide">
          ...
          <a href="https://wa.me/+552231995267" target="_blank" rel="noopener noreferrer" className="px-6 py-2 border border-gold-500/30 text-gold-400 rounded hover:bg-gold-500 hover:text-neutral-900 transition-all duration-300 shadow-[0_0_10px_rgba(212,175,55,0.1)] hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]">
            ÁREA DO CLIENTE
          </a>
        </div>
      </div>
