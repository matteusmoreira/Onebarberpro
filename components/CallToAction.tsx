    ...
    <section className="py-24 relative bg-neutral-950 overflow-hidden flex items-center justify-center text-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          <a href="https://wa.me/+552231995267" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto px-10 py-5 bg-gold-600 hover:bg-gold-500 text-neutral-950 text-lg font-bold rounded-lg shadow-[0_0_30px_rgba(197,160,40,0.4)] hover:shadow-[0_0_50px_rgba(197,160,40,0.6)] transition-all duration-300 transform hover:-translate-y-1">
            ADQUIRIR AGORA
          </a>
          
          <a href="https://wa.me/+552231995267" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto px-10 py-5 bg-transparent border border-neutral-700 hover:border-green-500 text-white text-lg font-semibold rounded-lg hover:bg-neutral-900 transition-all duration-300 flex items-center justify-center gap-3 group">
